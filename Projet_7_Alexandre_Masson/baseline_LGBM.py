...
df_train = pd.read_csv('preprocessing_train.csv')
...
def kfold_lightgbm(df_train,df_test, num_folds, stratified=False, debug=False):
...
def display_importances(feature_importance_df_):
    ...
    best_features.to_csv("best_fetaures.csv",index=False)
...
feat_importance = kfold_lightgbm(df_train,df_test, num_folds= 5, stratified= False, debug= 'debug')